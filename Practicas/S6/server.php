...
function build_autocomplete_payload()
{
    ...
    if ($type === 'hotel') {
        foreach ($hotels as $hotel) {
            if (stripos($hotel['name'], $query) !== false) {
                $items[] = array(
                    'name' => $hotel['name'],
...
function build_reservation_ajax_payload($result)
{
    ...
    return array(
        ...
        'reservation' => array(
            ...
            'hotelNom' => $dadesReserva['hotelNom'],
            ...
            <?php } elseif (empty($errors)) { ?>
                ...
                <div class="info-reserva">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo htmlspecialchars($dadesReserva['hotelNom']); ?></span>
                    </div>
                                ...
                                <tbody>
                                    <?php foreach ($result['recentReservations'] as $row) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars(isset($row['hotel_name']) ? $row['hotel_name'] : 'Sense hotel especificat'); ?></td>
