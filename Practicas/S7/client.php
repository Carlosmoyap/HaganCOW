...
<body>
    ...
    <div class="container">
        <div class="container-reserva">
            ...
            <!-- BOTO I CONTENIDOR PER A LA SESSIÓ 7: TRANSFERÈNCIA MITJANÇANT JSON -->
            <div class="panel panel-info">
                <div class="panel-heading d-flex justify-content-between align-items-center">
                    <strong>Gestió de Dades (Sessió 7: JSON Data)</strong>
                    <div class="pull-right">
                        <button type="button" id="btnLoadHotelsJson" class="btn btn-primary btn-sm">
                            <span class="glyphicon glyphicon-bed"></span> Carregar Hotels (JSON)
                        </button>
                        <button type="button" id="btnLoadUsersJson" class="btn btn-warning btn-sm" style="margin-left: 5px;">
                            <span class="glyphicon glyphicon-user"></span> Carregar Usuaris (JSON)
                        </button>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="panel-body">
                    <p class="text-muted">Aquesta secció demostra la recepció de dades estructurades des del servidor, codificades oportunament en format <strong>JSON</strong> fent múltiples consultes a columnes i taules.</p>
                </div>
                <div id="jsonResponseContainer" class="table-responsive" style="display: none;">
                    <!-- La taula amb les dades JSON es generarà aquí de forma dinàmica -->
                </div>
            </div>
